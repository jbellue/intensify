...
function intensify() {
	...
	var intense_link = document.getElementById("intensity_link");
	if (intense_link == undefined) {
		intense_link = document.createElement('a');
		intense_link.id = "intensity_link";
		document.getElementById("center").appendChild(intense_link);
	}
...
function create_gif(options) {
	...
	options.link_to_image.download = "intense.gif";
